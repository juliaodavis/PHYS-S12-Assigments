...
Some things to keep in mind:
	...
	- The first jumper wire (<font color="yellow"yellow>) goes to the 5V
	- The second jumper wire (<font color="orange"orange>) goes to the ground pin 
	- The third jumper wire (<font color="green"green>) goes to A0 pin 
