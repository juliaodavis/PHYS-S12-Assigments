...
Some things to keep in mind:
	...
	- The first jumper wire (<font color="yellow">yellow</font>) goes to the 5V
	- The second jumper wire (<font color="orange">orange</font>) goes to the ground pin 
	- The third jumper wire (<font color="green">green</font>) goes to A0 pin 
