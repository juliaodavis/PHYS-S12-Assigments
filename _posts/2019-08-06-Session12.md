...
[Code for Thermistor Arduino]: (http://www.circuitbasics.com/arduino-thermistor-temperature-sensor-tutorial/) 


Some things to keep in mind:

	- The resistance of the thermistor must equal the resistance of the resistor
	- <font color="FFDA33">The first jumper wire (yellow) goes to the 5V</font>
	- <font color="FF9633">The second jumper wire (orange) goes to the ground pin</font>
	- <font color="2B8A14">The third jumper wire (green) goes to A0 pin</font>
