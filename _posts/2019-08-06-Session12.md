...
Some things to keep in mind:
	...
	- The first jumper wire (<font color="FFDA33">yellow) goes to the 5V
	- The second jumper wire (<font color="FF9633">orange) goes to the ground pin 
	- The third jumper wire (<font color="2B8A14">green) goes to A0 pin 
