...
<BR>
To set up my circuit, I essentially combined the setup from the [touch sensor](https://roberthart56.github.io/SCFAB/SC_lab/Sensors/CapacitiveTouch/index.html) and for the RGB LEDs (one wire to 5V, one wire to pin 6, and one wire to ground). A schematic of my circuit as well as the actual circuit are shown below. 
<BR>
